    ...
    <div class="container">
        <div class="footer-top-grid">
            <div class="footer-brand">
                ...
                <p>{{ $description ?? 'Engineering enterprise-grade cloud platforms, microservices, and AI architectures for high-growth global innovators.' }}</p>
            ...
            <div class="footer-col">
                <h5>HQ & Contact</h5>
                <ul class="footer-links">
                    <li><span style="color: var(--text-muted);">{{ $address ?? '750 Innovation Way, San Francisco, CA' }}</span></li>
                    <li><a href="mailto:{{ $email ?? 'hello@novacore.tech' }}">{{ $email ?? 'hello@novacore.tech' }}</a></li>
                    <li><a href="tel:{{ $phone ?? '+18005550199' }}">{{ $phone ?? '+1 (800) 555-0199' }}</a></li>
        ...
        <div class="footer-bottom">
            <div class="footer-copyright">
                &copy; {{ date('Y') }} {{ $companyName ?? 'NovaCore Technologies' }}. All rights reserved. Built with Laravel 11.
            </div>
