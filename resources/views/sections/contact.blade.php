    ...
    <div class="container">
        ...
        <div class="contact-grid">
                ...
                <div class="contact-card-box">
                    <div class="contact-detail-row">
                        ...
                        <div class="contact-detail-text">
                            ...
                            <a href="mailto:{{ $email ?? 'hello@novacore.tech' }}">{{ $email ?? 'hello@novacore.tech' }}</a>
                        </div>
                    </div>
                    ...
                    <div class="contact-detail-row">
                        ...
                        <div class="contact-detail-text">
                            ...
                            <a href="tel:{{ $phone ?? '+18005550199' }}">{{ $phone ?? '+1 (800) 555-0199' }}</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="contact-form-card">
                ...
                <form id="contactForm" action="{{ route('contact.submit') ?? '/contact' }}" method="POST">
                    @csrf
                    <div class="form-row">
                        <div class="form-group">
                            <label class="form-label" for="inputName">Your Name *</label>
                            <input type="text" id="inputName" name="name" class="form-control" placeholder="e.g. Alex Morgan" required value="{{ old('name') }}">
                        </div>

                        <div class="form-group">
                            <label class="form-label" for="inputEmail">Work Email *</label>
                            <input type="email" id="inputEmail" name="email" class="form-control" placeholder="alex@company.com" required value="{{ old('email') }}">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="inputCompany">Company / Organization</label>
                        <input type="text" id="inputCompany" name="company" class="form-control" placeholder="e.g. Nexus Scale Labs" value="{{ old('company') }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="inputMessage" name="message" class="form-control" rows="4" placeholder="Describe what you want to build, tech stack preferences, timeline expectations, or current bottlenecks..." required>{{ old('message') }}</textarea>
                    </div>
